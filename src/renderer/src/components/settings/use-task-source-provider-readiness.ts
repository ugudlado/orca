...
export function useTaskSourceProviderReadiness(
  ...
  const backlogChecking =
    backlogStatusContextKey !== providerRuntimeContextKey || !backlogStatusChecked
  const backlogConnected = !backlogChecking && backlogStatus.connected === true
  ...
  return useMemo(() => {
    ...
    return {
      ...
      backlog: {
        ...
        checking: backlogChecking,
        visible: visible.has('backlog')
      }
    }
  }, [
    backlogChecking,
