...
export function areWorkspaceLinkedItemsEqual(
  ...
  return (
    ...
    (a.backlogTaskId ?? null) === (b.backlogTaskId ?? null) &&
    (a.backlogProjectId ?? null) === (b.backlogProjectId ?? null) &&
...
export function normalizeWorkspaceLinkedItem(value: unknown): WorkspaceLinkedItem | null {
  ...
  return {
    ...
    ...(typeof raw.jiraIdentifier === 'string' && raw.jiraIdentifier.trim().length > 0
      ...
      : {}),
    ...(typeof raw.backlogTaskId === 'string' && raw.backlogTaskId.trim().length > 0
      ? { backlogTaskId: raw.backlogTaskId.trim() }
      : {}),
    ...(typeof raw.backlogProjectId === 'string' && raw.backlogProjectId.trim().length > 0
      ? { backlogProjectId: raw.backlogProjectId.trim() }
      : {}),
