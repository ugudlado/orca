...
const {
  ...
  registerOrchestratorHandlersMock,
  ...
  registerOrchestratorHandlersMock: vi.fn(),
  ...
  registerBacklogHandlersMock: vi.fn(),
...
vi.mock('./orchestrator', () => ({
  registerOrchestratorHandlers: registerOrchestratorHandlersMock
}))
...
vi.mock('./backlog', () => ({
  registerBacklogHandlers: registerBacklogHandlersMock
}))
...
describe('registerCoreHandlers', () => {
  beforeEach(() => {
    ...
    registerOrchestratorHandlersMock.mockReset()
    ...
    registerBacklogHandlersMock.mockReset()
  ...
  it('passes the store through to handler registrars that need it', async () => {
    ...
    expect(registerOrchestratorHandlersMock).toHaveBeenCalled()
    ...
    expect(registerBacklogHandlersMock).toHaveBeenCalled()
